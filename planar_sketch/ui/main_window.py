...
class MainWindow(QMainWindow):
    ...
    def _build_menus(self):
        ...
        self.act_boundary_set_driver = QAction("", self)
        self.act_boundary_set_driver.triggered.connect(self.sim_panel._set_driver_from_selection)
        self.act_boundary_set_output = QAction("", self)
        self.act_boundary_set_output.triggered.connect(self.sim_panel._set_output_from_selection)
        self.act_boundary_point_line_s = QAction("", self)
        self.act_boundary_point_line_s.triggered.connect(self.ctrl.add_point_line_offset_from_selection)
    ...
    def _build_toolbars(self) -> None:
        ...
        self.toolbar_boundary.addAction(self.act_boundary_set_driver)
        self.toolbar_boundary.addAction(self.act_boundary_set_output)
        self.toolbar_boundary.addAction(self.act_boundary_point_line_s)
    ...
    def _apply_action_icons(self) -> None:
        ...
        self.act_boundary_set_driver.setIcon(style.standardIcon(QStyle.StandardPixmap.SP_BrowserReload))
        self.act_boundary_set_output.setIcon(style.standardIcon(QStyle.StandardPixmap.SP_ArrowForward))
        self.act_boundary_point_line_s.setIcon(style.standardIcon(QStyle.StandardPixmap.SP_DialogYesButton))
    ...
    def apply_language(self):
        ...
        self.act_boundary_set_driver.setText(tr(lang, "action.boundary_set_driver"))
        self.act_boundary_set_output.setText(tr(lang, "action.boundary_set_output"))
        self.act_boundary_point_line_s.setText(tr(lang, "action.boundary_point_line_s"))
